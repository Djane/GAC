...
public final class ObjectUtils {
    ...
    /**
     * Realiza a invoca��o ao método <i>methodName</i> e objeto <i>object</i> informado. Este método
     * deve seguir a especifica��o Java para métodos setters.
     * @param field the field
     * @param object Objeto a qual o método ser� executado.
    ...
    /**
     * Recupera a representa��o do método getter do atributo informado pelo argumento <i>field</i>.
     * @param field the field
     * @param object the object
    ...
    /**
     * Recupera o valor da anotação marcada nas propriedades do objeto informado. Note-se que ir�
     * retornar a primeira ocorr�ncia marcada com a anotação.
     * @param object the object
