...
/**
 * Classe que implementa o estado Manutenção.
 * @author ddiniz
 */
public class DispositivoManutencaoState implements DispositivoState {
	...
	public void validarDispositivo(List<DispositivoVO> listaDispositivos) throws BusinessException {
		for (DispositivoVO dispositivo : listaDispositivos) {
			dispositivo.setEstadoAtual(EstadoDispositivo.Pronto.getValue());
		}
	}
	...
	public void abrirDefeito(List<DispositivoVO> listaDispositivos) throws BusinessException {
		for (DispositivoVO dispositivo : listaDispositivos) {
			dispositivo.setEstadoAtual(EstadoDispositivo.Defeito.getValue());
		}
	}
	...
	public void descartarDispositivo(List<DispositivoVO> listaDispositivos) throws BusinessException {
		for (DispositivoVO dispositivo : listaDispositivos) {
			dispositivo.setEstadoAtual(EstadoDispositivo.Descarte.getValue());
		}
	}
	...
	private void lancaException() throws BusinessException {
		throw new BusinessException(BusinessExceptionMessages.MUDANCA_ESTADO_MANUTENCAO_INVALIDA);
	}
