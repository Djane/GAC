...
/**
 * Classe que implementa o estado Devolvido.
 * @author ddiniz
 */
public class DispositivoDevolvidoState implements DispositivoState {
	...
	private void lancaException() throws BusinessException {
		throw new BusinessException(BusinessExceptionMessages.MUDANCA_ESTADO_DEVOLVIDO_INVALIDA);
	}
